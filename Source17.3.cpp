...
public: 
    ...
    bool check() override
    {
        return  Triangle::check() && sideA == sideB && sideB == sideC && angleA == 60 && angleB == 60 && angleC == 60;
    }
};
...
public: 
    ...
    bool check() override
    {
        return angleA + angleB + angleC + angleD == 360;
    }
    int getSideCount() override
    {
        return 4;
...
public: 
    ...
    bool check() override
    {
        return  Quadrangle::check() && sideA == sideC && sideB == sideD && angleA == angleC && angleB == angleD;
    }
};
...
public: 
    ...
    bool check() override
    {
        return  Quadrangle::check() && sideA == sideC && sideB == sideD && angleA == 90 && angleC == 90 && angleB == 90 && angleD == 90;
    }
};
...
public: 
    ...
    bool check() override
    {
        return  Quadrangle::check() && sideA == sideB && sideB == sideC && sideC == sideD && angleA == angleC && angleB == angleD;
    }
};
...
public: 
    ...
    bool check() override
    {
        return Quadrangle::check() && sideA == sideB && sideB == sideC && sideC == sideD && angleA == 90 && angleC == 90 && angleB == 90 && angleD == 90;
    }
};
